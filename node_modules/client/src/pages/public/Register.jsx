            ...
            <div className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <input
                    type="text"
                    className="w-full px-6 py-5 rounded-3xl bg-gray-50 border-2 border-transparent focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 transition-all outline-none font-bold text-gray-900 placeholder:text-gray-400"
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-2">Create Password</label>
                <div className="relative group">
                  <input
                  ...
                  <button
                    ...
                    className="absolute right-6 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-blue-600 transition-colors hover:text-blue-600"
                  >
                    {showPassword ? (
