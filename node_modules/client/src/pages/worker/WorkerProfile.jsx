  ...
  const handleUpdate = async (e) => {
    ...
    try {
      if (isDemoMode) {
        ...
        // In development, try to update via API
        ...
        <div className="px-10 pb-10">
          <div className="flex flex-col md:flex-row items-end -mt-16 space-y-4 md:space-y-0 md:space-x-8">
            <div className="relative group">
              <img
                src={user.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name || user.displayName || user.email)}&background=random&size=200`}
            ...
            <div className="flex-1 pb-2">
              <h1 className="text-4xl font-black text-gray-900 mb-1">{user.name || user.displayName || 'Unnamed User'}</h1>
            ...
            <div className="flex space-x-4 pb-2">
              <div className="text-center px-6 py-3 bg-gray-50 rounded-3xl border border-gray-100">
                ...
                <p className="text-2xl font-black text-indigo-600">{user.coins || user.balance || 0}</p>
              </div>
              <div className="text-center px-6 py-3 bg-gray-50 rounded-3xl border border-gray-100">
                <p className="text-xs font-black text-gray-400 uppercase tracking-tighter">Earnings</p>
                <p className="text-2xl font-black text-green-600">{user.totalEarned || 0}</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-8 py-5 rounded-[2rem] bg-gray-50 border-2 border-transparent focus:bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-600/5 transition-all outline-none font-bold text-gray-900 placeholder:text-gray-400"
