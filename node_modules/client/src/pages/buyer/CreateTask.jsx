...
const CreateTask = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.coinsPerWorker || formData.coinsPerWorker < 1) {
      console.log('Validation failed: Invalid coins per worker:', formData.coinsPerWorker);
      toast.error('Please enter a valid reward amount (minimum 1 coin)');
      setLoading(false);
      return;
    }

    if (!formData.requiredWorkers || formData.requiredWorkers < 1) {
      console.log('Validation failed: Invalid required workers:', formData.requiredWorkers);
      toast.error('Please enter a valid number of workers (minimum 1)');
      setLoading(false);
      return;
    }
    ...
    console.log('All validation passed, proceeding with task creation');
    try {
        ...
        <div className="space-y-8">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-8 py-5 rounded-[2rem] bg-gray-50 border-2 border-transparent focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 transition-all outline-none font-bold text-gray-900 placeholder:text-gray-400"
              required
              maxLength={200}
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={6}
              className="w-full px-8 py-6 rounded-[2rem] bg-gray-50 border-2 border-transparent focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 transition-all outline-none font-medium leading-relaxed text-gray-900 placeholder:text-gray-400"
              required
              maxLength={2000}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  min="1"
                  className="w-full pl-16 pr-8 py-5 rounded-[2rem] bg-gray-50 border-2 border-transparent focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 transition-all outline-none font-bold text-gray-900 placeholder:text-gray-400"
                  required
                />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10">
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full px-8 py-5 rounded-[2rem] bg-gray-50 border-2 border-transparent focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 transition-all outline-none font-bold appearance-none text-gray-900"
            >
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full px-8 py-5 rounded-[2rem] bg-gray-50 border-2 border-transparent focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 transition-all outline-none font-bold text-gray-900"
            />
          </div>
        </div>
