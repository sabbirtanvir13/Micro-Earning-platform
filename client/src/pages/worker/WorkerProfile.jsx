  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-gray-600">Manage your account settings and view your performance.</p>
      </div>
        ...
        <div className="md:col-span-1">
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div className="px-6 pb-6 mt-[-3rem] flex flex-col items-center">
              ...
              <p className="text-sm text-indigo-600 font-semibold capitalize">{user.role}</p>
              ...
              <div className="mt-6 w-full space-y-3">
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-bold text-green-600">{user.totalEarned} Coins</span>
                </div>
                <div className="w-full bg-gray-100 h-1 mt-2 rounded-full overflow-hidden">
                  <div className="bg-indigo-600 h-full w-full opacity-20"></div>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="pt-6 border-t border-gray-100">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    <div className="bg-gray-50 p-4 rounded-xl">
                      <p className="text-xs text-gray-500 mb-1">Coins Earned</p>
                      <p className="text-lg font-bold text-gray-900">{user.totalEarned}</p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-xl">
                      <p className="text-xs text-gray-500 mb-1">Current Coins</p>
                      <p className="text-lg font-bold text-indigo-600">{user.coins}</p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-xl">
