      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Empowering the future of work. Connect with opportunities, complete tasks, and earn rewards in a trusted marketplace.
            </p>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-gray-800 hover:bg-blue-700 flex items-center justify-center transition-all duration-300 hover:scale-110"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* For Workers */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-white">For Workers</h4>
            <ul className="space-y-3">
              <li>
                <Link to="/worker/tasks" className="text-gray-400 hover:text-blue-400 transition-colors duration-200 flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span>
                  Browse Tasks
                </Link>
              </li>
              <li>
                <a href="#how-it-works" className="text-gray-400 hover:text-blue-400 transition-colors duration-200 flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span>
                  How It Works
                </a>
              </li>
              <li>
                <Link to="/worker/earnings" className="text-gray-400 hover:text-blue-400 transition-colors duration-200 flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span>
                  Earnings
                </Link>
              </li>
              <li>
                <Link to="/worker/withdraw" className="text-gray-400 hover:text-blue-400 transition-colors duration-200 flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span>
                  Withdraw
                </Link>
              </li>
          ...
          {/* For Buyers */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-white">For Buyers</h4>
            <ul className="space-y-3">
              <li>
                <Link to="/buyer/create-task" className="text-gray-400 hover:text-blue-400 transition-colors duration-200 flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span>
                  Post a Task
                </Link>
              </li>
              <li>
                <a href="#pricing" className="text-gray-400 hover:text-blue-400 transition-colors duration-200 flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span>
                  Pricing
                </a>
              </li>
              <li>
                <Link to="/buyer/my-tasks" className="text-gray-400 hover:text-blue-400 transition-colors duration-200 flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span>
                  My Tasks
                </Link>
              </li>
              <li>
                <a href="#support" className="text-gray-400 hover:text-blue-400 transition-colors duration-200 flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span>
                  Support
                </a>
              </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-gray-400 text-sm">
            © {currentYear} MicroEarn. All rights reserved.
          </div>
